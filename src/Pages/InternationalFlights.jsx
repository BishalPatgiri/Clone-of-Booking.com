...
const InternationalFlights = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get("https://sumitfirstapi.herokuapp.com/international", {
        ...
        <div className="ticket">
          {loading && (
            <div style={{ marginLeft: "205px" }}>
              <img src="https://c.tenor.com/qsdblRVNZysAAAAC/flying-airplane.gif"alt="inter"/>
            </div>
          )}
          {flightData.map((ele) => (
            <InternationalFlightsDetails
              key={ele.id}
              image={ele.image}
              company={ele.company}
              t1={ele.t1}
